...
<div id="pos-customers" x-data="{ openTab: 1, activeClasses:'shadow bg-white text-gray-800', inactiveClasses:'focus:bg-gray-500 text-white hover:text-white' }" class="shadow-lg rounded flex flex-col overflow-hidden" x-cloak>
    ...
    <div class="flex-auto flex p-2 overflow-y-auto">
        <div  x-show="openTab === 1" class="">
            ...
            <div class="h-full flex-col w-full flex items-center justify-center text-primary test_customer">
