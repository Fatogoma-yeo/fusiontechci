...
@section('content')
<div x-data ="{ openTab: 2, activeClasses:'shadow bg-white text-gray-800', inactiveClasses:'focus:bg-gray-100 text-white' }" class="flex-auto overflow-hidden flex flex-col p-2 h-screen" id="pos-container" x-cloak>
