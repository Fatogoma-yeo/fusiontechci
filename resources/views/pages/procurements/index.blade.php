                ...
                @forelse($procurements as $procurement)
                    <tr
                        ...
                        <td class="flex px-2 py-2 justify-end">
                            <a href="" class="inline-flex justify-center py-1 px-1 border border-transparent shadow-sm text-md font-medium rounded-md text-white bg-green-500 hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
